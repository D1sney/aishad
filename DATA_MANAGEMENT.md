...
- Прочитался новый файл
- Создались новые embeddings
- Обновился FAISS индекс

## Проверка обновлений

После перезапуска проверь логи:
```
Created XX chunks from data file
FAISS index created with XX vectors
```

Количество chunks изменится в зависимости от объема нового текста.
